...
/**
 * Class {@code ViewAllVouchers}
 *
 * @author Veronika Mazets
 * @version 1.0 29/07/2022
 */
public class ViewAllVouchers implements Command {

    private static final Logger logger = LogManager.getLogger();
    @Override
    public String execute(HttpServletRequest request) {
        logger.debug("start ViewAllVouchers");
        ...
        try {
            ...
            logger.error("ViewAllVouchers error.", e);
            page = PageContainer.ERROR_PAGE;
        }
        logger.debug("finish ViewAllVouchers");
        return page;
    }
}
