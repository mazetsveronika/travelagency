...
/**
 * Class {@code ProxyConnection} the proxy object contains the real class as a field to access
 * the functional if necessary real class. Implements wrapping technology
 * class to improve security and optimize the interaction.
...
public class ProxyConnection implements Connection {
    ...
    /**
     * After closing the connection it will be return to the connections pool
     *
     * @throws SQLException
     */
