...
public class OrderDaoImpl extends OrderDao {
    ...
    private BigDecimal calculateTotalPrice(Order order) {//??
        ...
        int discountPercent =(100 - order.getUser().getDiscount())/100;
        BigDecimal totalPriceDiscountNull = (order.getVoucher().getHotel().getPricePerDay().multiply(new BigDecimal(nights)).add(order.getVoucher().getTour().getTourPrice()));
        BigDecimal totalPrice =totalPriceDiscountNull.multiply (new BigDecimal(discountPercent));
        return totalPrice;
    }//todo
        ...
        if (id > 0) {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    tour.setTourType(rs.getString(7));
            ...
            } catch (SQLException | TravelAgencyException e) {
