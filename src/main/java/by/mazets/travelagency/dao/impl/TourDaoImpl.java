...
public class TourDaoImpl extends TourDao {
    ...
    public void create(AbstractEntity abstractEntity) throws TravelAgencyDaoException {
        ...
        if (abstractEntity instanceof Tour) {
            ...
            try {
                ...
                ps.setString(1, tour.getTourType());
                ps.setBigDecimal(2, tour.getTourPrice());
        ...
        if (id > 0) {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    tour.setTourType(rs.getString(2));
