...
<head>
    ...
    <fmt:bundle basename="localization">
        ...
        <fmt:message key="local.addVoucherTable" var="addVaucherTable"/>
...
<jsp:useBean id="vaucherService" class="by.mazets.travelagency.service.impl.VoucherServiceImpl" scope="application"/>
